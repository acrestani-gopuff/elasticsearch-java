...
//    }
    ...
    static <T> JsonpDeserializer<Map<String, T>> stringListOrMapDeserializer(JsonpDeserializer<T> itemDeserializer) {
        return new JsonpDeserializerBase.StringKeyListOrMapDeserializer<T>(itemDeserializer);
    }
